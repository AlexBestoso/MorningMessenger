class InboxViewUnreadForm : public Form{
	private:
	...
	public:
		InboxViewUnreadForm() : Form(){
			...
			// -- Setup save button.
                        ...
                        buttons[butt_save].setButtonText("Save");
		...
		void updateListButtons(void){
			cnt = morningMessage.getUnreadMessages(keyId, unreadMessages, 200);
                        if(cnt == 0){
